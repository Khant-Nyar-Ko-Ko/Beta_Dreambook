...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "yesrelative yesflex yescursor-default yesselect-none yesitems-center yesrounded-sm yespx-2 yespy-1.5 yestext-sm yesoutline-none aria-selected:yesbg-accent aria-selected:yestext-accent-foreground data-[disabled=true]:yespointer-events-none data-[disabled=true]:yesopacity-50",
      className
    )}
    {...props}
  />
