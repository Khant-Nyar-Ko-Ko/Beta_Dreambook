  ...
  "block rounded-md text-xs md:text-sm font-primary py-0 md:py-2 duration-300 ",
  {
    variants: {
      variant: {
        ...
        edit: "bg-white dark:bg-darkMode1 text-black dark:text-white border border-gray-300 focus:border-primary w-[150px] md:w-[800px]",
        chapterNum: "bg-white dark:bg-darkMode1 text-black dark:text-white border border-gray-300 focus:border-primary w-[150px] md:w-[100px]",
        ...
        search: "bg-white dark:bg-darkMode1 text-black dark:text-white border border-gray-300 focus:border-primary w-[100px] md:w-[360px]",
        ...
        phone: "bg-white text-black dark:text-white border-gray-300 border focus:border-none w-[150px] md:w-[270px]",
